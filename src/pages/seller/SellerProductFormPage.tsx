            ...
            <div className="space-y-4">
              ...
              <div className="pt-2 grid grid-cols-3 gap-2">
                <button
                  ...
                  className={`h-14 rounded-2xl border text-[10px] font-black uppercase tracking-wider flex items-center justify-center transition-all ${
                    inStock 
          ...
          <div className="space-y-4">
            ...
            {images.length > 0 ? (
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 pt-2">
                {images.map((img, i) => (
                  <div key={i} className="group relative aspect-square rounded-2xl border overflow-hidden bg-muted shadow-sm border-border/40">
              ...
              <div className="p-8 border border-dashed rounded-3xl flex flex-col items-center justify-center text-muted-foreground text-center gap-2 border-border/50 bg-muted/10">
