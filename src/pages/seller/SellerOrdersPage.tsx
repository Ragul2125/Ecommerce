    ...
    <div className="space-y-6 animate-in fade-in-50 duration-500">
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={`pb-4 text-xs font-black uppercase tracking-wider transition-all border-b-2 shrink-0 cursor-pointer ${
                activeTab === tab
      ...
      <div className="grid gap-6 lg:grid-cols-3">
                    ...
                    {filteredOrders.map((order) => (
                      <tr 
                        ...
                        className={`hover:bg-muted/10 transition-colors cursor-pointer ${
                          selectedOrder?.id === order.id ? "bg-muted/20" : ""
                        }`}
                      >
        ...
        <div className="space-y-4">
          {selectedOrder ? (
            <div className="glass rounded-[2rem] border border-border/40 p-6 shadow-premium space-y-6 bg-background/50 animate-in slide-in-from-right duration-300">
            ...
            <div className="p-8 border border-dashed rounded-[2rem] text-center text-muted-foreground bg-muted/10 h-full flex flex-col items-center justify-center gap-2 border-border/50">
