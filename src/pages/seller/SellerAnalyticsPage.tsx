...
export function SellerAnalyticsPage() {
  ...
  const [topProducts, setTopProducts] = useState<PerformanceData[]>([])
  ...
  useEffect(() => {
    async function loadAnalytics() {
      try {
        ...
        // Mocking top-selling products based on mockProducts values
        setTopProducts([
  ...
  const categoryDistribution = [
    { name: "Apparel", value: 58000, color: "#1A1A1A" },
    { name: "Accessories", value: 31000, color: "#666666" },
    { name: "Footwear", value: 18000, color: "#999999" },
    { name: "Bespoke", value: 12000, color: "#CCCCCC" }
  ]
