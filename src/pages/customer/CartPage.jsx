...
function CartPage() {
  ...
  if (items.length === 0) {
    return <div className="container mx-auto px-6 py-12 flex items-center justify-center">
        <EmptyState
      icon={ShoppingCart}
      title="Archive Empty"
  ...
  >
    ...
    className="w-full h-18 rounded-full bg-white text-black font-black text-sm uppercase tracking-widest shadow-2xl hover:bg-zinc-200 hover:text-black transition-all active:scale-[0.98]"
  >
