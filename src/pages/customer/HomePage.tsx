            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-12">
               ...
               <div className="flex items-center gap-6">
                  <div className="flex -space-x-4">
                      {['photo-1507003211169-0a1dd7228f2d', 'photo-1494790108377-be9c29b29330', 'photo-1539571696357-5a69c17a67c6'].map(id => (
                       <div key={id} className="h-14 w-14 rounded-full border-4 border-background bg-muted overflow-hidden">
         ...
         >
            ...
            <div className="absolute bottom-12 left-12 right-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
               <div className="space-y-4">
                  <Badge className="bg-white/10 backdrop-blur-md border-white/20 text-white rounded-full px-6 py-2 text-[9px] uppercase font-black tracking-widest">Masterpiece Series</Badge>
                  <h3 className="text-3xl md:text-5xl font-black text-white font-heading tracking-tighter">The Monolith Parka.</h3>
               </div>
               <Button className="h-16 px-10 rounded-full bg-white text-black font-black uppercase tracking-widest text-[10px] hover:bg-white/90 shadow-glow">
                  Acquire Artifact
               </Button>
            </div>
         </motion.div>
