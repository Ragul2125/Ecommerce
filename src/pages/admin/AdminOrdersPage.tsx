...
const initialOrders: MockOrder[] = [
  { id: "ORD-501", customer: "Alice Johnson", date: "2026-06-18", total: 120.50, status: "Delivered", items: 2 },
  { id: "ORD-502", customer: "Bob Smith", date: "2026-06-19", total: 45.00, status: "Processing", items: 1 },
...
export function AdminOrdersPage() {
  ...
  const [editOrder, setEditOrder] = useState<MockOrder | null>(null)
