  ...
  return <div className="space-y-6">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {recentOrders.map((order) => <div key={order.id} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                  <div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="space-y-4">
              {recentProducts.map((product) => <div key={product.id} className="flex items-center justify-between border-b pb-4 last:border-0 last:pb-0">
                  <div>
