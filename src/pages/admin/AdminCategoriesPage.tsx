...
export function AdminCategoriesPage() {
  ...
  const handleEdit = () => {
    ...
    setCategories(categories.map(c => 
      c.id === editCategory.id ? { ...c, name: formData.name, description: formData.description, imageUrl: formData.imageUrl } : c
    ))
  ...
  return (
    <div className="space-y-6 animate-in fade-in-50 duration-500">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button onClick={() => { setFormData({ name: "", description: "", imageUrl: "" }); setIsAddOpen(true); }} className="rounded-full h-12 px-6 bg-primary text-primary-foreground font-black text-xs uppercase tracking-wider cursor-pointer">
        ...
        <DialogContent>
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="space-y-2">
              ...
              {formData.imageUrl ? (
                <div className="relative h-32 w-full rounded-lg overflow-hidden border border-border/50 bg-muted flex items-center justify-center">
