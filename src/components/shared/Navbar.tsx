...
export function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-[100] w-full border-b border-border/30 bg-background/80 backdrop-blur-2xl transition-all duration-500 pt-[env(safe-area-inset-top,0px)]">
