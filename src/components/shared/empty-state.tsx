...
export function EmptyState({ 
  ...
  return (
    ...
    >
      ...
      {actionLabel && (
        <Button asChild className="rounded-full px-10 h-14 font-black tracking-tighter shadow-xl shadow-primary/20 transition-all hover:scale-105 active:scale-95">
          <Link to={actionLink}>
            {actionLabel}
          </Link>
        </Button>
