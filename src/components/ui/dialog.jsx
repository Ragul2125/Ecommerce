...
>
      {children}
      <DialogPrimitive.Close className="absolute right-6 top-6 rounded-full h-10 w-10 flex items-center justify-center border border-border/10 bg-muted/40 text-muted-foreground hover:text-foreground hover:bg-muted/70 transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none cursor-pointer">
        <X className="h-4 w-4" />
