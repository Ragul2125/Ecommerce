...
const ALL_FLASH_ITEMS = [
  ...
  { id: "f4", name: "Cashmere Scarf", price: 15500, salePrice: 7750, image: "https://images.unsplash.com/photo-1520903920243-00d872a2d1c9?w=400&q=80" },
  { id: "f5", name: "Leather Gloves", price: 12400, salePrice: 6200, image: "https://images.unsplash.com/photo-1517036683526-7ee6541655db?w=400&q=80" },
  { id: "f6", name: "Aviator Sunglasses", price: 18500, salePrice: 9250, image: "https://images.unsplash.com/photo-1511499767150-a48a237f0083?w=400&q=80" }
];
function FlashSale() {
  ...
  const TimeBlock = ({ val }) => {
    ...
    return <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-primary-foreground text-primary font-black shadow-md border border-primary-foreground/10">
        {display}
      </div>;
  };
